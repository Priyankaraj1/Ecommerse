...
<div class="container" id="content">
    ...
    <div class="col-lg">
        ...
        <h1>Get in Touch</h1>
        <p id="p1">Hi there, we are here to help you.<br> Please feel free to contact us in case you have any queries regarding the products, payment or order delivery.<br>
    </div><br><br>
    <div class="col-lg">
